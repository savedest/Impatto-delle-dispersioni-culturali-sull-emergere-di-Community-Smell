...
df_dataset = df_dataset.dropna(subset=['CV_1', 'CV_2', 'CV_3', 'CV_4', 'CV_5', 'CV_6', 'CV_7', 'CV_8', 'CV_9', 'radio'])

# Salva il dataframe aggiornato nel file Excel
df_dataset.to_excel('C:\\Users\\saver\\PycharmProjects\\Community_smell\\radio_silence\\radio_silence_metrics_globe.xlsx', index=False)
df_dataset.to_csv('C:\\Users\\saver\\PycharmProjects\\Community_smell\\radio_silence\\radio_silence_metrics_globe.csv', index=False, sep=';')
