...
df_dataset = df_dataset.dropna(subset=['CV_1', 'CV_2', 'CV_3', 'CV_4', 'CV_5', 'CV_6', 'organisation'])

# Save the updated dataframe to a CSV file
df_dataset.to_excel('C:\\Users\\saver\\PycharmProjects\\Community_smell\\organisation_silo\\organisation_silo_metrics_hofstede.xlsx', index=False)
df_dataset.to_csv('C:\\Users\\saver\\PycharmProjects\\Community_smell\\organisation_silo\\organisation_silo_metrics_hofstede.csv', index=False, sep=';')
