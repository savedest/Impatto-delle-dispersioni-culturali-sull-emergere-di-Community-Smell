...
df_dataset = pd.read_excel('C:\\Users\\saver\\PycharmProjects\\Community_smell\\organisation_silo\\organisation.xlsx')
...
df_dataset = df_dataset.dropna(subset=['CV_1', 'CV_2', 'CV_3', 'CV_4', 'CV_5', 'CV_6', 'CV_7', 'CV_8', 'organisation'])

# Salva il dataframe aggiornato nel file Excel
df_dataset.to_excel('C:\\Users\\saver\\PycharmProjects\\Community_smell\\organisation_silo\\organisation_silo_metrics_trompenaars.xlsx', index=False)

df_dataset.to_csv('C:\\Users\\saver\\PycharmProjects\\Community_smell\\organisation_silo\\organisation_silo_metrics_trompenaars.csv', index=False, sep=';')
