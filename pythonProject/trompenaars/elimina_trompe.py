...
file_path = 'C:\\Users\\saver\\PycharmProjects\\pythonProject\\trompenaars\\deviazione_standard_trompenaars_second.xlsx'  # Sostituisci con il percorso del tuo file Excel
...
# Filtra il DataFrame
df_filtrato = df[df['Universalism/Particularism'].apply(lambda x: isinstance(x, str) and contiene_almeno_due_numeri_interi(x))]

# Salva il risultato in un nuovo file Excel
output_file = 'file_filtrato_trompenaars.xlsx'
