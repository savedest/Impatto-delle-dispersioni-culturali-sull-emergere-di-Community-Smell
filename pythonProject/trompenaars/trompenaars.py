...
df_dataset['CV_UP'] = df_dataset.apply(lambda row: calc_CV(row, 'Universalism/Particularism'), axis=1)
...
df_dataset['CV_IC'] = df_dataset.apply(lambda row: calc_CV(row, 'Individualism/Communitarianism'), axis=1)
...
df_dataset['CV_Sp'] = df_dataset.apply(lambda row: calc_CV(row, 'Specific/Diffuse'), axis=1)
...
df_dataset['CV_NA'] = df_dataset.apply(lambda row: calc_CV(row, 'Neutral/Affective'), axis=1)
...
df_dataset['CV_AA'] = df_dataset.apply(lambda row: calc_CV(row, 'Achievement/Ascription'), axis=1)
...
df_dataset['CV_PPF'] = df_dataset.apply(lambda row: calc_CV(row, 'Past,Present,Future'), axis=1)
...
df_dataset['CV_SS'] = df_dataset.apply(lambda row: calc_CV(row, 'Sequential/Synchronic'), axis=1)
...
df_dataset['CV_IE'] = df_dataset.apply(lambda row: calc_CV(row, 'Internal/External'), axis=1)

# Salva il dataframe aggiornato nel file Excel
df_dataset.to_excel('deviazione_standard_trompenaars_second.xlsx', index=False)
